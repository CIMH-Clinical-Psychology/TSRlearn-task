...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisBlock in Block:
        ...
        if Block.thisN == 0:
            context_img_block = "stimuli\context_imges\sea_01.jpg"
        if Block.thisN == 1:
            context_img_block = "stimuli\context_imges\forest_01.jpg"
        if Block.thisN == 2:
            context_img_block = "stimuli\context_imges\snow_01.jpg"
        if Block.thisN == 3:
            context_img_block = "stimuli\context_imges\desert_02.jpg"
