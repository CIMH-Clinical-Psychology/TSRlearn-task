...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    textbox_feedback = visual.TextBox2(
         win, text=None, placeholder='Type here...', font='Sans Sherif',
         ori=0.0, pos=(0, 0.2), draggable=False,      letterHeight=0.025,
    ...
    textbox_continue = visual.TextBox2(
         win, text=None, placeholder='Type here...', font='Sans Sherif',
         ori=0.0, pos=(0, -0.15), draggable=False,      letterHeight=0.025,
    ...
    background_texture = visual.ImageStim(
        win=win,
        name='background_texture', 
        image='C:/Users/sianna.groesser/Downloads/texture_01.jpg', mask=None, anchor='center',
    ...
    background_texture_2 = visual.ImageStim(
        win=win,
        name='background_texture_2', 
        image='C:/Users/sianna.groesser/Downloads/texture_01.jpg', mask=None, anchor='center',
        ori=0.0, pos=(0, 0), draggable=False, size=(0.5, 0.5),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
    ...
    background_texture_3 = visual.ImageStim(
        win=win,
        name='background_texture_3', 
        image='C:/Users/sianna.groesser/Downloads/texture_01.jpg', mask=None, anchor='center',
        ori=0.0, pos=(0, 0), draggable=False, size=(0.5, 0.5),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
    ...
    background_texture_4 = visual.ImageStim(
        win=win,
        name='background_texture_4', 
        image='C:/Users/sianna.groesser/Downloads/texture_01.jpg', mask=None, anchor='center',
        ori=0.0, pos=(0, 0), draggable=False, size=(0.5, 0.5),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
    ...
    background_texture_5 = visual.ImageStim(
        win=win,
        name='background_texture_5', 
        image='C:/Users/sianna.groesser/Downloads/texture_01.jpg', mask=None, anchor='center',
        ori=0.0, pos=(0, 0), draggable=False, size=(0.5, 0.5),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
    ...
    background_texture_6 = visual.ImageStim(
        win=win,
        name='background_texture_6', 
        image='C:/Users/sianna.groesser/Downloads/texture_01.jpg', mask=None, anchor='center',
        ori=0.0, pos=(0, 0), draggable=False, size=(0.5, 0.5),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
    ...
    background_texture_7 = visual.ImageStim(
        win=win,
        name='background_texture_7', 
        image='C:/Users/sianna.groesser/Downloads/texture_01.jpg', mask=None, anchor='center',
        ori=0.0, pos=(0, 0), draggable=False, size=(0.5, 0.5),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
    ...
    background_texture_8 = visual.ImageStim(
        win=win,
        name='background_texture_8', 
        image='C:/Users/sianna.groesser/Downloads/texture_01.jpg', mask=None, anchor='center',
        ori=0.0, pos=(0, 0), draggable=False, size=(0.5, 0.5),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
    ...
    background_texture_9 = visual.ImageStim(
        win=win,
        name='background_texture_9', 
        image='C:/Users/sianna.groesser/Downloads/texture_01.jpg', mask=None, anchor='center',
        ori=0.0, pos=(0, 0), draggable=False, size=(0.5, 0.5),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
        ...
        for thisMiniblock in miniblocks:
            ...
            for thisLearning_trial in learning_trials:
                ...
                choice_display = data.Routine(
                    name='choice_display',
                    components=[background_texture, polygon_4, prompt, dist_01, dist_02, correct, chooseNowText, key_resp],
                )
                ...
                while continueRoutine:
                    ...
                    # *background_texture* updates
                    
                    # if background_texture is starting this frame...
                    if background_texture.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                        # keep track of start time/frame for later
                        background_texture.frameNStart = frameN  # exact frame index
                        background_texture.tStart = t  # local t and not account for scr refresh
                        background_texture.tStartRefresh = tThisFlipGlobal  # on global time
                        win.timeOnFlip(background_texture, 'tStartRefresh')  # time at next scr refresh
                        # add timestamp to datafile
                        thisExp.timestampOnFlip(win, 'background_texture.started')
                        # update status
                        background_texture.status = STARTED
                        background_texture.setAutoDraw(True)
                    
                    # if background_texture is active this frame...
                    if background_texture.status == STARTED:
                        # update params
                        pass
                ...
                feedback = data.Routine(
                    name='feedback',
                    components=[background_texture_2, polygon_8, prompt_2, dist_01_2, dist_02_2, correct_2],
                )
                ...
                while continueRoutine:
                    ...
                    # *background_texture_2* updates
                    
                    # if background_texture_2 is starting this frame...
                    if background_texture_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                        # keep track of start time/frame for later
                        background_texture_2.frameNStart = frameN  # exact frame index
                        background_texture_2.tStart = t  # local t and not account for scr refresh
                        background_texture_2.tStartRefresh = tThisFlipGlobal  # on global time
                        win.timeOnFlip(background_texture_2, 'tStartRefresh')  # time at next scr refresh
                        # add timestamp to datafile
                        thisExp.timestampOnFlip(win, 'background_texture_2.started')
                        # update status
                        background_texture_2.status = STARTED
                        background_texture_2.setAutoDraw(True)
                    
                    # if background_texture_2 is active this frame...
                    if background_texture_2.status == STARTED:
                        # update params
                        pass
            ...
            for thisRetrieval_trial in retrieval_trials:
                ...
                first_image = data.Routine(
                    name='first_image',
                    components=[background_texture_3, image_1],
                )
                ...
                while continueRoutine:
                    ...
                    # *background_texture_3* updates
                    
                    # if background_texture_3 is starting this frame...
                    if background_texture_3.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                        # keep track of start time/frame for later
                        background_texture_3.frameNStart = frameN  # exact frame index
                        background_texture_3.tStart = t  # local t and not account for scr refresh
                        background_texture_3.tStartRefresh = tThisFlipGlobal  # on global time
                        win.timeOnFlip(background_texture_3, 'tStartRefresh')  # time at next scr refresh
                        # add timestamp to datafile
                        thisExp.timestampOnFlip(win, 'background_texture_3.started')
                        # update status
                        background_texture_3.status = STARTED
                        background_texture_3.setAutoDraw(True)
                    
                    # if background_texture_3 is active this frame...
                    if background_texture_3.status == STARTED:
                        # update params
                        pass
                    
                    # if background_texture_3 is stopping this frame...
                    if background_texture_3.status == STARTED:
                        # is it time to stop? (based on global clock, using actual start)
                        if tThisFlipGlobal > background_texture_3.tStartRefresh + image_dur_retr_new-frameTolerance:
                            # keep track of stop time/frame for later
                            background_texture_3.tStop = t  # not accounting for scr refresh
                            background_texture_3.tStopRefresh = tThisFlipGlobal  # on global time
                            background_texture_3.frameNStop = frameN  # exact frame index
                            # add timestamp to datafile
                            thisExp.timestampOnFlip(win, 'background_texture_3.stopped')
                            # update status
                            background_texture_3.status = FINISHED
                            background_texture_3.setAutoDraw(False)
                ...
                mask_retr1 = data.Routine(
                    name='mask_retr1',
                    components=[background_texture_4, mask_img1_2],
                )
                ...
                while continueRoutine and routineTimer.getTime() < 0.25:
                    ...
                    # *background_texture_4* updates
                    
                    # if background_texture_4 is starting this frame...
                    if background_texture_4.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                        # keep track of start time/frame for later
                        background_texture_4.frameNStart = frameN  # exact frame index
                        background_texture_4.tStart = t  # local t and not account for scr refresh
                        background_texture_4.tStartRefresh = tThisFlipGlobal  # on global time
                        win.timeOnFlip(background_texture_4, 'tStartRefresh')  # time at next scr refresh
                        # add timestamp to datafile
                        thisExp.timestampOnFlip(win, 'background_texture_4.started')
                        # update status
                        background_texture_4.status = STARTED
                        background_texture_4.setAutoDraw(True)
                    
                    # if background_texture_4 is active this frame...
                    if background_texture_4.status == STARTED:
                        # update params
                        pass
                    
                    # if background_texture_4 is stopping this frame...
                    if background_texture_4.status == STARTED:
                        # is it time to stop? (based on global clock, using actual start)
                        if tThisFlipGlobal > background_texture_4.tStartRefresh + 0.25-frameTolerance:
                            # keep track of stop time/frame for later
                            background_texture_4.tStop = t  # not accounting for scr refresh
                            background_texture_4.tStopRefresh = tThisFlipGlobal  # on global time
                            background_texture_4.frameNStop = frameN  # exact frame index
                            # add timestamp to datafile
                            thisExp.timestampOnFlip(win, 'background_texture_4.stopped')
                            # update status
                            background_texture_4.status = FINISHED
                            background_texture_4.setAutoDraw(False)
                ...
                second_image = data.Routine(
                    name='second_image',
                    components=[background_texture_5, image_2],
                )
                ...
                while continueRoutine:
                    ...
                    # *background_texture_5* updates
                    
                    # if background_texture_5 is starting this frame...
                    if background_texture_5.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                        # keep track of start time/frame for later
                        background_texture_5.frameNStart = frameN  # exact frame index
                        background_texture_5.tStart = t  # local t and not account for scr refresh
                        background_texture_5.tStartRefresh = tThisFlipGlobal  # on global time
                        win.timeOnFlip(background_texture_5, 'tStartRefresh')  # time at next scr refresh
                        # add timestamp to datafile
                        thisExp.timestampOnFlip(win, 'background_texture_5.started')
                        # update status
                        background_texture_5.status = STARTED
                        background_texture_5.setAutoDraw(True)
                    
                    # if background_texture_5 is active this frame...
                    if background_texture_5.status == STARTED:
                        # update params
                        pass
                    
                    # if background_texture_5 is stopping this frame...
                    if background_texture_5.status == STARTED:
                        # is it time to stop? (based on global clock, using actual start)
                        if tThisFlipGlobal > background_texture_5.tStartRefresh + image_dur_retr_new-frameTolerance:
                            # keep track of stop time/frame for later
                            background_texture_5.tStop = t  # not accounting for scr refresh
                            background_texture_5.tStopRefresh = tThisFlipGlobal  # on global time
                            background_texture_5.frameNStop = frameN  # exact frame index
                            # add timestamp to datafile
                            thisExp.timestampOnFlip(win, 'background_texture_5.stopped')
                            # update status
                            background_texture_5.status = FINISHED
                            background_texture_5.setAutoDraw(False)
                ...
                mask_retr2 = data.Routine(
                    name='mask_retr2',
                    components=[background_texture_6, mask_img2_2],
                )
                ...
                while continueRoutine and routineTimer.getTime() < 0.25:
                    ...
                    # *background_texture_6* updates
                    
                    # if background_texture_6 is starting this frame...
                    if background_texture_6.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                        # keep track of start time/frame for later
                        background_texture_6.frameNStart = frameN  # exact frame index
                        background_texture_6.tStart = t  # local t and not account for scr refresh
                        background_texture_6.tStartRefresh = tThisFlipGlobal  # on global time
                        win.timeOnFlip(background_texture_6, 'tStartRefresh')  # time at next scr refresh
                        # add timestamp to datafile
                        thisExp.timestampOnFlip(win, 'background_texture_6.started')
                        # update status
                        background_texture_6.status = STARTED
                        background_texture_6.setAutoDraw(True)
                    
                    # if background_texture_6 is active this frame...
                    if background_texture_6.status == STARTED:
                        # update params
                        pass
                    
                    # if background_texture_6 is stopping this frame...
                    if background_texture_6.status == STARTED:
                        # is it time to stop? (based on global clock, using actual start)
                        if tThisFlipGlobal > background_texture_6.tStartRefresh + 0.25-frameTolerance:
                            # keep track of stop time/frame for later
                            background_texture_6.tStop = t  # not accounting for scr refresh
                            background_texture_6.tStopRefresh = tThisFlipGlobal  # on global time
                            background_texture_6.frameNStop = frameN  # exact frame index
                            # add timestamp to datafile
                            thisExp.timestampOnFlip(win, 'background_texture_6.stopped')
                            # update status
                            background_texture_6.status = FINISHED
                            background_texture_6.setAutoDraw(False)
                ...
                reflection_period_retr = data.Routine(
                    ...
                    components=[background_texture_7, fix_cross_reflretr],
                )
                ...
                while continueRoutine:
                    ...
                    # *background_texture_7* updates
                    
                    # if background_texture_7 is starting this frame...
                    if background_texture_7.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                        # keep track of start time/frame for later
                        background_texture_7.frameNStart = frameN  # exact frame index
                        background_texture_7.tStart = t  # local t and not account for scr refresh
                        background_texture_7.tStartRefresh = tThisFlipGlobal  # on global time
                        win.timeOnFlip(background_texture_7, 'tStartRefresh')  # time at next scr refresh
                        # add timestamp to datafile
                        thisExp.timestampOnFlip(win, 'background_texture_7.started')
                        # update status
                        background_texture_7.status = STARTED
                        background_texture_7.setAutoDraw(True)
                    
                    # if background_texture_7 is active this frame...
                    if background_texture_7.status == STARTED:
                        # update params
                        pass
                    
                    # if background_texture_7 is stopping this frame...
                    if background_texture_7.status == STARTED:
                        # is it time to stop? (based on global clock, using actual start)
                        if tThisFlipGlobal > background_texture_7.tStartRefresh + reflection_win_dur-frameTolerance:
                            # keep track of stop time/frame for later
                            background_texture_7.tStop = t  # not accounting for scr refresh
                            background_texture_7.tStopRefresh = tThisFlipGlobal  # on global time
                            background_texture_7.frameNStop = frameN  # exact frame index
                            # add timestamp to datafile
                            thisExp.timestampOnFlip(win, 'background_texture_7.stopped')
                            # update status
                            background_texture_7.status = FINISHED
                            background_texture_7.setAutoDraw(False)
                ...
                retr_response_order = data.Routine(
                    ...
                    components=[background_texture_8, polygon_6, yes_txt, no_txt, chooseNowText_2, resp],
                )
                ...
                while continueRoutine:
                    ...
                    # *background_texture_8* updates
                    
                    # if background_texture_8 is starting this frame...
                    if background_texture_8.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                        # keep track of start time/frame for later
                        background_texture_8.frameNStart = frameN  # exact frame index
                        background_texture_8.tStart = t  # local t and not account for scr refresh
                        background_texture_8.tStartRefresh = tThisFlipGlobal  # on global time
                        win.timeOnFlip(background_texture_8, 'tStartRefresh')  # time at next scr refresh
                        # add timestamp to datafile
                        thisExp.timestampOnFlip(win, 'background_texture_8.started')
                        # update status
                        background_texture_8.status = STARTED
                        background_texture_8.setAutoDraw(True)
                    
                    # if background_texture_8 is active this frame...
                    if background_texture_8.status == STARTED:
                        # update params
                        pass
                    
                    # if background_texture_8 is stopping this frame...
                    if background_texture_8.status == STARTED:
                        # is it time to stop? (based on global clock, using actual start)
                        if tThisFlipGlobal > background_texture_8.tStartRefresh + retr_dur-frameTolerance:
                            # keep track of stop time/frame for later
                            background_texture_8.tStop = t  # not accounting for scr refresh
                            background_texture_8.tStopRefresh = tThisFlipGlobal  # on global time
                            background_texture_8.frameNStop = frameN  # exact frame index
                            # add timestamp to datafile
                            thisExp.timestampOnFlip(win, 'background_texture_8.stopped')
                            # update status
                            background_texture_8.status = FINISHED
                            background_texture_8.setAutoDraw(False)
                ...
                retr_response_distance = data.Routine(
                    ...
                    components=[background_texture_9, chooseNowText_3, resp_4, opt_2, opt_3, opt_4, opt_5],
                )
                ...
                while continueRoutine:
                    ...
                    # *background_texture_9* updates
                    
                    # if background_texture_9 is starting this frame...
                    if background_texture_9.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                        # keep track of start time/frame for later
                        background_texture_9.frameNStart = frameN  # exact frame index
                        background_texture_9.tStart = t  # local t and not account for scr refresh
                        background_texture_9.tStartRefresh = tThisFlipGlobal  # on global time
                        win.timeOnFlip(background_texture_9, 'tStartRefresh')  # time at next scr refresh
                        # add timestamp to datafile
                        thisExp.timestampOnFlip(win, 'background_texture_9.started')
                        # update status
                        background_texture_9.status = STARTED
                        background_texture_9.setAutoDraw(True)
                    
                    # if background_texture_9 is active this frame...
                    if background_texture_9.status == STARTED:
                        # update params
                        pass
                    
                    # if background_texture_9 is stopping this frame...
                    if background_texture_9.status == STARTED:
                        # is it time to stop? (based on global clock, using actual start)
                        if tThisFlipGlobal > background_texture_9.tStartRefresh + retr_dur_slider-frameTolerance:
                            # keep track of stop time/frame for later
                            background_texture_9.tStop = t  # not accounting for scr refresh
                            background_texture_9.tStopRefresh = tThisFlipGlobal  # on global time
                            background_texture_9.frameNStop = frameN  # exact frame index
                            # add timestamp to datafile
                            thisExp.timestampOnFlip(win, 'background_texture_9.stopped')
                            # update status
                            background_texture_9.status = FINISHED
                            background_texture_9.setAutoDraw(False)
