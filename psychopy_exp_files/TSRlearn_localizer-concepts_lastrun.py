...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    conditions_file = f"sequences/localizer_conditions_{p_num:02d}.xlsx"
    ...
    if language == "english": 
       ...
       "Welcome to the first part of the experiment.\n"
        ...
        "and hear words.\n"
        "Your task is to decide if the words describe what you see in the images.\n\n"
    ...
    "The MEG signal is very sensitive to eye\n"
    "and body movements.\n\n"
    "[Press any key to continue.]"
    )
    ...
    "Please try to move and blink as little\n"
    "as possible during each task block.\n\n"
    "After each task block, there will be a short break\n"
    "where you can rest and move a little.\n"
    "As soon as the task starts again, please stop moving\n"
    ...
    if language == "english": 
        ...
        "You have finished the first part of the task. Press any key to exit. "
    )
       
    if language == "german": 
        instruction_end.text = (
        "Sie haben den ersten Teil der Aufgabe beendet. Drücken Sie eine beliebige Taste, um zu beenden. "
    )
